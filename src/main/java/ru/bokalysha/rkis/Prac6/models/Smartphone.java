...
public class Smartphone {
    ...
    @Column(name = "brand")
    @Size(min = 1, max = 50, message = "Длина бренда должна быть от 1 до 50")
    private String brand;

    @Column(name = "model")
    @Size(min = 1, max = 50, message = "Длина модели должна быть от 1 до 50")
    private String model;

    @Column(name = "operating_system")
    @Size(min = 1, max = 20, message = "Длина цвета должна быть от 1 до 20")
    ...
    public String toString() {
        return "Smartphone{" + "id=" + id + ", brand='" + brand + '\'' + ", model='" + model + '\'' + ", operating_system='" + operating_system + '\'' + ", storage_capacity_gb=" + storage_capacity_gb + ", price_usd=" + price + '}';
    }

package ru.bokalysha.rkis.Prac6.config;
...
import ru.bokalysha.rkis.Prac6.services.ShopUserDetailsService;

/**
 * Класс конфигурации для настройки SpringSecurity в приложении.
 */
@Configuration
@ComponentScan("ru.bokalysha.rkis.Prac6")
@EnableWebSecurity
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers("/smartphone/*/edit", "/smartphone/add").hasRole("ADMIN")
                ...
                .formLogin(formLogin ->
                        formLogin
                                ...
                                .defaultSuccessUrl("/smartphone", true)
